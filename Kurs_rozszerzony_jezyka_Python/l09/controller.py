...
class Controller:
    ...
    def __init__(self, db, list_view, add_view, edit_view, switch_views):
        """
    ...
    def search_contacts(self, event):
        ...
        if regex:
            self.list_view.set(self.db.search_contacts(regex))
        else:
            self.refresh_list()
    ...
    def show_edit_view(self, event):
        ...
        fields = self.db.get_contact_fields(selected_id)[:-1]
    ...
    def edit_contact(self, event):
        ...
        try:
            updated_contact = Contact(*fields)
        except ValueError as e:
        ...
        self.db.update_contact(updated_contact, contact_id)
        self.currently_selected_id = None
        self.refresh_list()
        self.switch_views(self.edit_view, self.list_view)
    ...
    def refresh_list(self):
        ...
        self.list_view.set(self.db.get_contacts())
